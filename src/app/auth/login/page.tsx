...
export default function LoginPage() {
  ...
  const [isSigningIn, setIsSigningIn] = useState(false); // For email/password
  const [isGoogleSigningIn, setIsGoogleSigningIn] = useState(false); // For Google
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      let friendlyMessage = "Falha ao fazer login com Google.";
       if (authError.code === 'auth/popup-closed-by-user') {
        friendlyMessage = "Login com Google cancelado.";
      } else if (authError.code === 'auth/cancelled-popup-request') {
        friendlyMessage = "Múltiplas tentativas de login com Google. Por favor, tente novamente.";
      } else if (authError.code === 'auth/popup-blocked') {
        friendlyMessage = "O pop-up de login com Google foi bloqueado pelo navegador. Por favor, habilite pop-ups para este site e tente novamente.";
      }
  ...
  const handleEmailPasswordSignIn = async (e: FormEvent) => {
    ...
    try {
      ...
      switch (authError.code) {
        ...
        case 'auth/invalid-credential': // Covers user-not-found and wrong-password for newer SDK versions
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-background p-4">
      ...
      <Card className="w-full max-w-md shadow-2xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Use seu email e senha ou sua conta Google.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          >
            ...
            {isGoogleSigningIn ? "Entrando com Google..." : "Entrar com Google"}
          </Button>
