...
const mockHistoricalCalls: HistoricalCall[] = [
  ...
  },
  {
    ...
    reason: "Solana ecosystem hype.",
    entryPrice: 0.000020,
    exitPrice: 0.000028,
    targets: [{ price: 0.000025 }, { price: 0.000030 }],
    stopLoss: 0.000018,
    result: "Win",
    profitOrLossAmount: 400,
    profitOrLossPercentage: "+40.00%",
  },
];
...
export default function TradeHistoryPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-headline font-semibold">Trade History</h1>
      ...
      {filteredCalls.length > 0 ? (
        <div className="space-y-4">
         ...
         <div className="flex flex-col items-center justify-center h-64 bg-card rounded-lg p-8">
          ...
          <h2 className="text-xl font-headline text-foreground mb-2">No Trades Found</h2>
          <p className="text-muted-foreground text-center">Your search or filter returned no results. Try adjusting your criteria or check back later.</p>
        </div>
      )}
    </div>
  );
